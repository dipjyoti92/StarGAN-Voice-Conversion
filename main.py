...
def main(config):
    ...
    test_loader = TestDataset(config.test_data_dir, config.wav_dir, src_spk='p225', trg_spk='p232')   # ********************************************
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_rec', type=float, default=50, help='weight for reconstruction loss')
    ...
    parser.add_argument('--beta', type=float, default=0.5, help='beta for cumulant funtion')
    parser.add_argument('--gamma', type=float, default=0.5, help='gamma for cumulant funtion')
